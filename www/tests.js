...
console.log('------------');
console.log(window.parseAttributes('div'));

console.dir('div>span'.toHtml());
...
console.log(window.parseAttributes('span.class1.class2#id1[hello=world num=8 countries=\'Kosovo DNR USSR\' autocomplete]{some text $@3}*15'));
